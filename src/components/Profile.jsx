...
const Profile = () => {
  return (
    <div className="p-12 font-normal">
      <Link to="/" className="mb-8 block hover:text-blue-400">
        -
      </Link>
      ...
      <div className="w-full flex justify-between max-w-3xl mt-12">
        <div className="leading-loose text-xs sm:text-base">
          ...
          <h4>
            <a href="mailto:lsf.move@gmail.com" className="hover:text-blue-400">
              lsf.mov@gmail.com
            </a>
          </h4>
          +1 786-547-2024
        ...
        <ul
          className="leading-loose text-right w-[120px] [&>li:hover]:text-blue-400 
                        [&>li:hover]:cursor-pointer text-xs sm:text-base"
        >
          <p className="italic font-bold">LINKS</p>
          <li>
            <a href="http://www.linkedin.com/in/lsfnyc">LinkedIn</a>
          </li>
          <li>
            <a href="https://vimeo.com/lsfnyc">Vimeo</a>
          </li>
          <li>
            <a href="https://www.instagram.com/lsf.mov/">Instagram</a>
          </li>
          <li>
